...
- Persistent identifier: https://doi.org/10.5281/zenodo.20012818 (Zenodo concept DOI; resolves to most recent version).
...
- **DOI handling.** Both DOI references in the preprint (abstract + §References) carry the concept DOI `https://doi.org/10.5281/zenodo.20012818` (Zenodo, sponsor-confirmed retrievable 2026-05-04, substituted in-file per AOV-91 board direction Cowork local-board comment `e001a922`, 2026-05-05). No fabricated DOI URL appears in this draft.
